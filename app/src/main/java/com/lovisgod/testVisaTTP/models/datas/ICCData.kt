...
import com.lovisgod.nfcpos.utils.BerTlvBuilder
import com.lovisgod.testVisaTTP.handlers.BertTlv.BerTlvParser
...
internal val REQUEST_TAGS = listOf(ICCData.AUTHORIZATION_REQUEST,
 ...
 fun getIccData(data: ByteArray): RequestIccData {
...
fun getIccString(data: ByteArray): String {
    ...
    val iccDataByteArray = tlvBuilder.buildArray()
    return HexUtil.toHexString(iccDataByteArray)
}
